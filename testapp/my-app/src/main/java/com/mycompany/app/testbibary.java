...
public class testbibary {
    ...
    public void generateTiFFFile() throws IOException {
        ...
        File original_f3 = new File("C:\\Users\\admin\\Desktop\\chequeOutput\\backbinary.tiff");
        ...
        try {
            ...
            OutputStream out = new FileOutputStream("C:\\Users\\admin\\Desktop\\chequeOutput\\Combined.tiff");
    ...
    public void convertTIFF() throws IOException {
        //String inputDir = "C:\\Users\\admin\\Desktop\\chequeOutput\\";
        File original_f1 = new File("C:\\Users\\admin\\Desktop\\chequeOutput\\cmpresseimg.jpg");
        File file[]={original_f1};
        int numImages = file.length;
        ArrayList<BufferedImage> images = new ArrayList<BufferedImage>();
        try {
            for (int i = 0; i < numImages; i++) {
                ...
                SeekableStream ss = new FileSeekableStream(file[i]);
                //ImageDecoder decoder = getDecoder(ss);
                ImageDecoder decoder = ImageCodec.createImageDecoder("jpeg", ss, null);
                int numPages = decoder.getNumPages();
                System.out.print(numPages+"a*");
                for(int j = 0; j < numPages; j++)
                {
            ...
            TIFFEncodeParam params = new TIFFEncodeParam();
            OutputStream out = new FileOutputStream("C:\\Users\\admin\\Desktop\\chequeOutput\\cmpresseimg.jpg");
            ImageEncoder encoder = ImageCodec.createImageEncoder("tiff", out, params);
            ArrayList<BufferedImage> imageList = new ArrayList<BufferedImage>();
            for (int i = 1; i < images.size(); i++) {
                imageList.add(images.get(i));
